defmodule GameSetupTest do
  ...
  describe "setup_players/1" do
    ...
    test "returns players containing a Human player 1 and an Easy Computer player 2 with their assosciated symbols" do
      user_inputs = ["1", "2", "1"]
      start_supervised!({@mock_command_line.communicator, user_inputs})
    ...
    test "returns players containing a Human player 1 and an Unbeatable Computer player 2 with their assosciated symbols" do
      user_inputs = ["1", "2", "2"]
      start_supervised!({@mock_command_line.communicator, user_inputs})
    ...
    test "returns players containing an Easy Computer player 1 and Human player 2 with their assosciated symbols" do
      user_inputs = ["2", "1", "1"]
      start_supervised!({@mock_command_line.communicator, user_inputs})
    ...
    test "returns players containing an Unbeatable Computer player 1 and Human player 2 with their assosciated symbols" do
      user_inputs = ["2", "2", "1"]
      start_supervised!({@mock_command_line.communicator, user_inputs})
    ...
    test "returns players containing an Easy Computer player 1 and an Easy Computer player 2 with their assosciated symbols" do
      user_inputs = ["2", "1", "2", "1"]
      start_supervised!({@mock_command_line.communicator, user_inputs})
    ...
    test "returns players containing an Easy Computer player 1 and an Unbeatable Computer player 2 with their assosciated symbols" do
      user_inputs = ["2", "1", "2", "2"]
      start_supervised!({@mock_command_line.communicator, user_inputs})
    ...
    test "returns players containing an Unbeatable Computer player 1 and an Easy Computer player 2 with their assosciated symbols" do
      user_inputs = ["2", "2", "2", "1"]
      start_supervised!({@mock_command_line.communicator, user_inputs})
    ...
    test "returns players containing an Unbeatable Computer player 1 and an Unbeatable Computer player 2 with their assosciated symbols" do
      user_inputs = ["2", "2", "2", "2"]
      start_supervised!({@mock_command_line.communicator, user_inputs})
